          ...
          <ScrollView>
            {this.state.posts.length
              ? this.state.posts.map((post, index) => {
                  return (
                    <View key="feed-subview" style={{marginBottom: 30}}>
                      ...
                      <View
                        ...
                        <View
                          ...
                          <TouchableOpacity
                            onPress={() =>
                              this.getProfileUserById(post.user_id)
                            }>
                            <Text
                              style={{
                                marginLeft: 5,
                      ...
                      <View
                        ...
                        <TouchableOpacity
                          onPress={() => {
                            this.getLocationById(post.location);
                          }}>
                          <View
                            style={{
                              flexDirection: 'row',
